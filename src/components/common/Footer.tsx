export default function Example() {
  return (
    <>
      ...
      <footer className="flex flex-col bg-gradient-to-b from-[#000001] to-[#191146] items-center justify-around w-full py-16 text-sm text-gray-800/70">
        <div className="flex items-center gap-8">
          <a href="#" className="font-medium text-white hover:text-black transition-all">
            Home
          </a>
          <a href="#" className="font-medium text-white hover:text-black transition-all">
            About
        ...
        <p className="mt-8 text-white text-center">Copyright © 2025 <a href="/">ServiceHub</a>. All rights reservered.</p>
      </footer>
    </>
  );
};