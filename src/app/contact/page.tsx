...
export default function Example() {
  return (
    <div className="isolate bg-gradient-to-t from-[#000001] via-[#191146] to-[#000001] px-6 py-24 sm:py-32 lg:px-8">
      <div
        aria-hidden="true"
      ...
      >
        <div
          ...
          className="relative left-1/2 -z-10 aspect-1155/678 w-144.5 max-w-none -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#000001] via-[#191146] to-[#000001] opacity-20 sm:left-[calc(50%-40rem)] sm:w-288.75"
        />
      </div>
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight text-balance text-white sm:text-5xl">Contact sales</h2>
        <p className="mt-2 text-lg/8 text-white">Looking to hire for a specific role or need enterprise solutions? Our sales team is here to help you find the perfect match for your needs.</p>
      </div>
